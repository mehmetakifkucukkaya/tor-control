...
const features = [
  ...
  },
  {
    ...
    description: "Tor Media Agency ailesi ile moral desteği ve güçlü bir topluluk deneyimi.",
    color: "cyan",
  },
  {
    icon: Headphones,
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center max-w-6xl mx-auto mb-16">
          ...
          <ScrollAnimationWrapper animation="fade-left" className="text-center lg:text-left order-1 lg:order-2">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-display font-bold mb-6">
              Sağladığımız <span className="gradient-text">Destekler</span>
            </h2>
            <p className="text-lg text-muted-foreground">
              TikTok LIVE yayıncılarına kapsamlı destek sunuyoruz. Ekipmandan eğitime, jeton bonusundan topluluk
              desteğine kadar her alanda yanındayız.
            </p>
          </ScrollAnimationWrapper>
        </div>
          ...
          {features.map((feature, index) => {
            ...
            return (
              <ScrollAnimationWrapper key={index} animation="fade-up" delay={index * 100}>
                ...
                >
                  <div
                    className={`w-14 h-14 rounded-xl bg-muted/50 flex items-center justify-center mb-6 transition-all duration-300 group-hover:scale-110`}
                  >
