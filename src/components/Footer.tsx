      ...
      <div className="container px-4">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <a href="https://www.instagram.com/torajans.tiktok" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full glass-card flex items-center justify-center hover:scale-110 transition-transform border border-border/50 hover:border-neon-magenta/50">
              <svg className="w-5 h-5 text-foreground" fill="currentColor" viewBox="0 0 24 24">
